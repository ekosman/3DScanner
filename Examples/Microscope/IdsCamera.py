...
class Camera:
    ...
    def get_exposure_range(self):
        ...
        ueye.is_Exposure(self.h_cam, ueye.IS_EXPOSURE_CMD_GET_EXPOSURE_RANGE_MIN, exposure_min,
                         ueye.sizeof(exposure_min))
        ueye.is_Exposure(self.h_cam, ueye.IS_EXPOSURE_CMD_GET_EXPOSURE_RANGE_MAX, exposure_max,
                         ueye.sizeof(exposure_max))
        ueye.is_Exposure(self.h_cam, ueye.IS_EXPOSURE_CMD_GET_EXPOSURE_RANGE_INC, exposure_inc,
    ...
    def set_auto_gain(self):
        ...
        if self.auto_gain == True:
            ...
            ueye.is_SetAutoParameter(self.h_cam, ueye.IS_SET_ENABLE_AUTO_GAIN, param, param2)
        else:
            param = ueye.DOUBLE(1)
    ...
    def get_auto_gain_max(self):
        ...
        val2 = ueye.DOUBLE(0)
        ueye.is_SetAutoParameter(self.h_cam, ueye.IS_GET_AUTO_GAIN_MAX, returned_gain, val2)
        return returned_gain.value

    def set_gain(self, master, red, green, blue):
        master, red, green, blue = ueye.INT(master), ueye.INT(red), ueye.INT(green), ueye.INT(blue)
    ...
    def get_gain(self):
        ...
        nGreen = 0
        nBlue = 0
        return ueye.is_SetHardwareGain(self.h_cam, ueye.IS_GET_MASTER_GAIN, nRed, nGreen, nBlue)
