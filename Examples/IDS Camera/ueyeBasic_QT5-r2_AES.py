...
class CaptureVideoWidget(QWidget):
    ...
    def auto_shutter(self):
        ...
        if self.autogain:
            ...
            ueye.is_SetAutoParameter(self.hCam, ueye.IS_SET_ENABLE_AUTO_SHUTTER, param, param2)
            self.autogain = False
        else:
            param = ueye.DOUBLE(64)
            param2 = ueye.DOUBLE(0)
            nret = ueye.is_SetAutoParameter(self.hCam, ueye.IS_SET_AUTO_REFERENCE, param, param2)
            print(nret)
            param = ueye.DOUBLE(1)
            nret = ueye.is_SetAutoParameter(self.hCam, ueye.IS_SET_ENABLE_AUTO_SHUTTER, param, param2)
            print(nret)
            self.autogain = True
